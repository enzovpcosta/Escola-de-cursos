...
<html lang="en">
  ...
  <body class="bg-dark text-light">
        <div class="bg-primary d-flex justify-content-between align-items-center py-4 px-5 text-light">
            <div>
                <h1><a href="menu.php" class="text-light text-decoration-none">Escola de cursos</a></h1>
